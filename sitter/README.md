...
## Files
- `index.html` the page
- `config.js` every setting: name, contact details, booked dates, services, what you say no to
...
- **Block dates** once a booking is confirmed: add `'2026-11-26'` for one day or `['2026-12-20', '2026-12-27']` for a stretch, inside `booked: [ ]`, separated by commas.
- **Area**: set `area` to your neighborhood name.
- **What Lucas keeps**: fill in `keeps`, for example `'Bearded dragon, 3 years'`.
- **Boarding**: set `boarding: true` once cages are set up at home.
