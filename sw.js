...
const VERSION = 'rlog-1.4.2';
const SHELL = ['./', './index.html', './photos.js?v=1.4.2', './species.js?v=1.4.2', './license.js?v=1.4.2', './core.js?v=1.4.2', './app.js?v=1.4.2', './manifest.webmanifest?v=1.4.2', './icons/icon-192.png', './icons/icon-512.png'];
